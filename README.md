...
Traditionally, Tor uses a stream cipher, a public-key cipher, the Diffie-Hellman protocol, and a hash function. For a stream cipher, Tor uses 128-bit AES in counter mode, with an IV of all 0 bytes. For a public-key cipher, Tor uses RSA with 1024- bit keys and a fixed exponent of 65537.
